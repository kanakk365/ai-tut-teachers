...
export default function ExamGradeSelectionPage() {
  ...
  const handleGradeSelect = (standard: GroupedStandard) => {
    // Store the selected standard in sessionStorage for the exam creation flow
    ...
    sessionStorage.setItem('selectedExamStandard', JSON.stringify(standardData))
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Create Exam - Select Grade</h1>
          <p className="text-gray-600">Choose from your assigned grades/classes for this exam</p>
        </div>
