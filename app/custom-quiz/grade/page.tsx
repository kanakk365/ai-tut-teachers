...
export default function CustomQuizGradePage() {
  ...
  const handleGradeSelect = (standard: GroupedStandard) => {
    // Store the selected standard in sessionStorage for the custom quiz creation flow
    ...
    sessionStorage.setItem('customQuizSelectedStandard', JSON.stringify(standardData))
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Choose from your assigned grades/classes for this custom quiz</p>
        </div>
