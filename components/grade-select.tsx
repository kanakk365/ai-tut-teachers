...
export function GradeSelection() {
  ...
  const handleGradeSelect = (standard: Standard) => {
    // Store the selected standard in sessionStorage for the section selection
    sessionStorage.setItem('selectedStandard', JSON.stringify(standard))
    router.push(`/quizzes/grade/${standard.id}/sections`)
  }

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-gray-900">Select Grade</h1>
